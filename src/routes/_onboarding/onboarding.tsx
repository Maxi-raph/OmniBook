  ...
  return(
    <div className='pt-6'>
      ...
      <div className="bg-surface-elevated max-w-4xl mx-auto mt-6 rounded-xl shadow-lg shadow-shadow-heavy py-6">
        ...
        <p className="text-sm px-6 text-text-muted">These details will be visible on your public booking page</p>
        ...
        <div className="flex flex-col px-6 gap-2 mt-6">
          ...
          <AnimatedButton
            ...
            border-text-muted text-text-muted px-3 py-2 bg-surface shadow-lg shadow-shadow-light">
          ...
          <p className="text-xs text-text-muted flex items-center gap-1 mt-2"><Info className='shrink-0 text-accent-hover' size={16}/> This link is unique to you. You can share this directly with clients once you finish setup.</p>
        </div>
      </div>
      <div className="mt-8 max-w-4xl mx-auto flex items-center justify-end">
        <AnimatedButton
        func={()=>null}
        classes='hidden font-semibold text-sm justify-center items-center bg-surface-elevated px-6 py-2 rounded-xl cursor-pointer shadow-lg shadow-shadow-glow'
        >Back</AnimatedButton>
        <AnimatedButton
        func={()=>navigate({to:'/onboarding/availability'})}
        classes='bg-accent-hover text-surface font-semibold text-sm flex justify-center items-center px-4 py-2 gap-2 rounded-xl cursor-pointer shadow-lg shadow-shadow-glow'
