...
function signUpPage() {
  return(
    <div className='block mt-6 page-wrap pb-6'>
      ...
      <form action="" onSubmit={()=>undefined} className="bg-surface/80 p-8 rounded-xl flex flex-col gap-6 max-w-3xl mx-auto shadow-shadow-light shadow-2xl">
        ...
        <div className="flex flex-col gap-2">
          ...
          <input type="text" id='name' name='name' className='w-full h-11 border border-border-default rounded-xl px-3 text-sm text-text-primary
        ...
        <div className="flex flex-col gap-2">
          ...
          <input type="text" id='email' name='email' className='w-full h-11 border border-border-default rounded-xl px-3 text-sm text-text-primary
           placeholder:text-text-muted focus:border-accent-primary focus:outline-none focus:ring-2 focus:ring-accent-primary/20'/>
        </div>
        <div className="flex flex-col gap-2">
          <label className='font-bold' htmlFor="password">Password</label>
          <input type="text" id='password' name='password' className='w-full h-11 border border-border-default rounded-xl px-3 text-sm text-text-primary
           placeholder:text-text-muted focus:border-accent-primary focus:outline-none focus:ring-2 focus:ring-accent-primary/20'/>
        </div>
        <div className="flex flex-col gap-2">
          <label className='font-bold' htmlFor="confirmPassword">Confirm Password</label>
          <input type="text" id='confirmPassword' name='confirmPassword' className='w-full h-11 border border-border-default rounded-xl px-3 text-sm text-text-primary
           placeholder:text-text-muted focus:border-accent-primary focus:outline-none focus:ring-2 focus:ring-accent-primary/20'/>
        </div>
        <div className="flex flex-col gap-2">
          <label className='font-bold' htmlFor="businessName">Business Name</label>
          <input type="text" id='businessName' name='businessName' className='w-full h-11 border border-border-default rounded-xl px-3 text-sm text-text-primary
           placeholder:text-text-muted focus:border-accent-primary focus:outline-none focus:ring-2 focus:ring-accent-primary/20'/>
        </div>
        <AnimatedButton 
         type="submit"
        ...
        <p className="text-sm text-text-muted text-center">By clicking create account, you agree to our <a href='#' className='text-accent-text ml-0.5 mr-0.5'>terms and conditions</a> 
