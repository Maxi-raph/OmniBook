...
export const Route = createFileRoute('/_marketing/')({
  ...
  head: ()=>({
    meta: [
      ...
      { name: 'description', 
        content: 'OmniBook automates your booking, payments, and client management — so you can focus on your craft. Time-zone aware booking, Stripe payments upfront, and automatic confirmations.' },
    ]
  })
})
  ...
  return(
    <div className='mt-14 page-wrap'>
      <section className="grid gap-12 grid-cols-1 md:grid-cols-2 items-center ">
        <AnimatedContainer
          ...
          <div className="flex gap-4 items-center mt-2 md:flex-wrap lg:flex-nowrap">
            ...
            <AnimatedLink
              route="/"
              classes="flex items-center justify-center gap-1.5 rounded-lg bg-transparent hover:bg-surface border border-default px-4 py-2 w-44 text-sm font-semibold shadow-lg shadow-shadow-heavy text-text-secondary transition-all duration-200"
      ...
      <AnimatedContainer 
       ...
       <h2 className="text-text-primary font-bold text-3xl text-center">Everything you need to scale</h2>
       <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-center">
        <AnimatedContainer
          ...
          <AnimatedLink
            route='/'
            classes="mt-6 inline-flex items-center gap-1 text-sm font-semibold text-accent-primary hover:text-accent-hover"
          >
      ...
      <AnimatedContainer
        ...
        <div className="page-wrap mx-auto max-w-2xl text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            ...
            <AnimatedLink
              route='/'
              classes="inline-flex items-center gap-2 rounded-lg border border-border-default bg-background
               px-6 py-2 text-sm font-semibold text-text-primary transition-colors hover:bg-surface shadow-lg shadow-shadow-heavy">
              Talk to Sales
            </AnimatedLink>
          </div>
        </div>
